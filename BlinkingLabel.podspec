...
#   * Finally, don't worry about the indent, CocoaPods strips it!  
  ...
  s.homepage         = "https://github.com/polgass/BlinkingLabel"
  # s.screenshots     = "www.example.com/screenshots_1", "www.example.com/screenshots_2"
  s.license          = 'MIT'
  s.author           = { "Paul Sevilla" => "pppsevilla@gmail.com" }
  s.source           = { :git => "https://github.com/polgass/BlinkingLabel.git", :tag => s.version.to_s }
